...
import { FaChartLine, FaUsers, FaHandshake, FaFutbol, FaBasketballBall, FaTableTennis, FaTrophy, FaCoins, FaRocket, FaBolt, FaFireAlt, FaMedal, FaShieldAlt, FaChartBar, FaStar } from 'react-icons/fa';
    ...
    <div className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white min-h-screen">
      ...
      <section className="py-20 bg-gray-800 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2 
            className="text-5xl font-bold mb-16 text-center font-orbitron bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-cyan-500"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {statsData.map((stat, index) => (
              <motion.div 
                key={stat.label}
                className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl shadow-xl transform hover:scale-105 transition duration-300 hover:shadow-neon-mixed"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2 
            ...
            transition={{ duration: 0.5 }}
          >
            Team-Created Markets
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredMarkets.map((market, index) => (
              <motion.div 
                key={market.id}
                className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition duration-300 hover:shadow-neon-mixed"
        ...
        <div className="absolute inset-0 bg-[url('/images/stadium-bg.jpg')] bg-cover bg-center opacity-5"></div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div 
                key={step.title}
                className="bg-gradient-to-br from-gray-900 to-gray-800 p-8 rounded-2xl shadow-xl text-center transform hover:scale-105 transition duration-300 hover:shadow-neon-mixed"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center">
                        <div className="w-full bg-gray-700 rounded-full h-2.5 mr-2">
                          <motion.div 
                            className="bg-gradient-to-r from-pink-500 to-cyan-500 h-2.5 rounded-full" 
                            initial={{ width: 0 }}
        ...
        <div className="absolute inset-0 bg-[url('/images/crowd-bg.jpg')] bg-cover bg-center opacity-5"></div>
      </section>
      ...
      <section className="py-20 bg-gray-800 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.h2 
            className="text-5xl font-bold mb-16 text-center font-orbitron bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-green-400"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
            Why Choose FanPredix?
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="flex items-center justify-center mb-6">
                  <div className="bg-gradient-to-r from-blue-400 to-green-400 p-4 rounded-full">
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <motion.div 
            className="bg-gradient-to-r from-pink-500 to-cyan-500 rounded-3xl shadow-2xl overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
        ...
        <div className="absolute inset-0 bg-[url('/images/stadium-lights.jpg')] bg-cover bg-center opacity-5"></div>
      </section>

      {/* Floating Achievement Notification */}
      <motion.div
        className="fixed bottom-4 right-4 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-lg p-4 shadow-lg"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 2, duration: 0.5 }}
      >
        <div className="flex items-center">
          <FaStar className="text-2xl text-white mr-2" />
          <div>
            <p className="font-bold text-white">New Achievement Unlocked!</p>
            <p className="text-sm text-white">Welcome to FanPredix</p>
          </div>
        </div>
      </motion.div>
    </div>
